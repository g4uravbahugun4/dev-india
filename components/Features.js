...
<div id="features">
  <div className="max-w-7xl mx-auto px-6 md:px-12 xl:px-6 py-40">
    <div className="md:w-2/3 lg:w-1/2">
      ...
      <p className="text-gray-600 dark:text-gray-300">Tasks ahead: map your area, clean meticulously, grow plants, and implement sustainable practices. Nurture seeds to create a flourishing green haven. Set up irrigation, compost, and embrace nature. Transform your space into a thriving environment, fostering a deeper connection with the natural world.</p>
    </div>
    <div
    ...
    >
      <div className="group relative bg-white dark:bg-gray-800 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10">
        <div className="relative space-y-8 py-12 p-8">
          ...
          <Link href="/main" className="flex items-center justify-between group-hover:text-secondary">
